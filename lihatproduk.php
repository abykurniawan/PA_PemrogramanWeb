        ...
        <div class="sidebar">
            <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px; height: 730px;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="lihatproduk.php" class="nav-link active">
                    ...
                    <li>
                        <a href="lihatmasukan.php" class="nav-link link-dark">
                ...
                <div class="col-sm-4 mb-3">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="updateproduk.php?id_produk=<?php echo $row ["id_produk"]; ?>" role="button"><i class="fa-solid fa-pen-to-square" style="color: #b53e65; margin-right: 10px;"></i></a>
